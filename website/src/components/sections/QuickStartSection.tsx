        ...
        <CardContent className="space-y-8">
          ...
          <div className="space-y-4 rounded-2xl bg-slate-100 p-6 dark:bg-slate-800">
            ...
            <div className="grid gap-4 text-sm sm:grid-cols-2">
              <a
                href="https://github.com/digablesolutions/logcat-agent/blob/main/docs/real-device-testing.md"
                target="_blank"
                rel="noreferrer"
              ...
              <a
                href="https://github.com/digablesolutions/logcat-agent/blob/main/docs/custom-patterns.md"
                target="_blank"
                rel="noreferrer"
                className="flex items-center gap-2 text-blue-600 transition-colors hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300"
              >
