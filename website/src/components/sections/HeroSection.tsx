    ...
    <section className="space-y-8 py-12 text-center">
      ...
      <div className="mx-auto max-w-4xl space-y-6">
        ...
        <div className="flex justify-center">
          <a
            href="https://github.com/kistradegoods/logcat-agent#local-slms-openai-compatible"
            target="_blank"
            rel="noreferrer"
      ...
      <div className="flex flex-col items-center justify-center gap-4 pt-8 sm:flex-row">
        ...
        >
          <a
            href="https://github.com/kistradegoods/logcat-agent#readme"
            target="_blank"
            rel="noreferrer"
        ...
        >
          <a
            href="https://github.com/kistradegoods/logcat-agent"
            target="_blank"
            rel="noreferrer"
